...
def private_to_public():
    ...
    priv_key = third_party.rsa.key.PrivateKey.load_pkcs1(in_data, cli.inform)
    pub_key = third_party.rsa.key.PublicKey(priv_key.n, priv_key.e)
